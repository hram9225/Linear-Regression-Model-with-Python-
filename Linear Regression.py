...
# Example usage with the given datapoints
...
bounce_height = get_y(0.4, 1.6, 6)

print("Based on the model, the 6cm ball will bounce " + str(bounce_height) + ' m.')
